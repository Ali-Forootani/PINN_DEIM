...
class AllenCahnDeepModelEntireDomain(DeepSimulation):
    def __init__(self,  in_features, out_features,
                 hidden_features_str, 
                 hidden_layers,  learning_rate_inr=1e-5
                 ):            
    ...
    def optimizer_func(self, ):
        ...
        self.optim_adam = torch.optim.Adam(
            [
                {
                    "params": self.model_str.parameters(),
                    "lr": self.learning_rate_inr,
                    "weight_decay": 1e-6,
                },
            ]
...
class PDEDeepModelEntireDomain(DeepSimulation):
    def __init__(self,  in_features, out_features,
                 hidden_features_str, 
                 hidden_layers,  learning_rate_inr=1e-5
                 ):            
...
class PDEDeepModel(DeepSimulation):
    def __init__(self,  in_features, out_features,
                 hidden_features_str, 
                 hidden_layers,  learning_rate_inr=1e-5
                 ):            
...
class PDEDeepModelSplitDomain(DeepSimulation):
    def __init__(self,  in_features, out_features,
                 hidden_features_str, 
                 hidden_layers,  learning_rate_inr=1e-5
                 ):            
