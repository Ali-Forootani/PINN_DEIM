...
(   x_train_list,
    ...
    train_loaders,
    X_test,
    u_test) = AllenCahn_instance.prepare_data_random(test_data_size)
...
result_path = "./logs/result_AC_1d/results" + string_f
p = Path(result_path)
if not p.exists():
...
plt.savefig(filename_data + "_dataset_" + " random_sampling" + ".png", dpi=300)
plt.savefig(filename_data + "_dataset_" + " random_sampling" + ".pdf", dpi=300)
plt.show()
