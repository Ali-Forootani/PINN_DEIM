...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 25 10:25:19 2023
...
(   x_train_list,
    ...
    train_loaders,
    X_test,
    u_test)  = KDV_instance.prepare_data_random(
                                                    test_data_size = 0.98
                                                    )
...
result_path = "./result_DEIM_KVD_1d/results" + string_f
p = Path(result_path)
if not p.exists():
...
scatter = ax_5.scatter(
    ...
    marker="D",
    s=20,
    label=r"Sampled dataset: Random",
)
