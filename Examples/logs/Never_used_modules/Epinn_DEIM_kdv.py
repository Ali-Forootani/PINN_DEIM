...
deim_instance = DEIM(Exact, 6, t_o, x_o, dec_rate=1, num_basis= 20)
...
deim_instance_2 = DEIM(Exact, 10, t_o, x_o, dec_rate=0, num_basis= 10)
...
deim_instance_3 = DEIM(Exact, 10, t_o, x_o, dec_rate=0, num_basis= 10)
...
deim_instance_4 = DEIM(Exact, 10, t_o, x_o, dec_rate=0, num_basis= 10)
...
for epoch in range(num_epochs):
    ...
    loss = 0.25*loss_data_1 + 0.25*loss_data_2 + 0.5*loss_f2 + 0.25*loss_f1 
