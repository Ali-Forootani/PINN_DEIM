...
ax[0, 0].scatter(
    X_str_train_1[:, 1], X_str_train_1[:, 0], c=u_str_train_1[:, 0], marker="x", s=10
)
ax[1, 0].scatter(
    X_str_train_f1[:, 1], X_str_train_f1[:, 0], c=u_str_train_f1[:, 0], marker="x", s=10
)

ax[0, 1].scatter(
    X_str_train_2[:, 1], X_str_train_2[:, 0], c=u_str_train_2[:, 0], marker="x", s=10
)
ax[1, 1].scatter(
    X_str_train_f2[:, 1], X_str_train_f2[:, 0], c=u_str_train_f2[:, 0], marker="x", s=10
)
...
########################################
############# Training the ensembled neural networks  
...
plt.savefig(
    filename_coef_s1 + "coefficients" + "random_sampling" + ".png",
    dpi=300,
)
plt.savefig(
    filename_coef_s1 + "coefficients" + "random_sampling" + ".pdf",
    dpi=300,
)
...
u_pred_test_torch = model_str_1(X_str_test_torch)
...
cbar3 = fig_6.colorbar(mappable=scatter3, ax=ax_6[2], ticks=ticker.MultipleLocator(0.3))
...
plt.savefig(
    filename_data + "prediction_error" + "random_sampling" + ".png",
    dpi=300,
)
plt.savefig(
    filename_data + "prediction_error" + "random_sampling" + ".pdf",
    dpi=300,
)
plt.show()
