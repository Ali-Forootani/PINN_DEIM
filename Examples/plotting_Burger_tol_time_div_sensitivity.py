...
### You have to run `Burger_data_generation.py` first then you can run this module

"""


string_f = "_Burger_" + "comparing_" + "different_time_division_" + "different_tol_"
...
filename_coef_random_samp = (
    result_path + "/" + "Burger_coef_dic_list_random_samp" + ".npy"
)
filename_data_random_points = (
    result_path + "/" + "Burger_list_data_random_points" + ".npy"
)
filename_coef_track_random_samp = (
    result_path + "/" + "Burger_coef_dic_track_list_random_samp" + ".npy"
)


Burger_Random_points = np.load(filename_data_random_points, allow_pickle=True)
...
filename_coef_DEIM = (
    result_path + "/" + "Burger_coef_dic_list_diff_tol_diff_tim_DEIM" + ".npy"
)
filename_data_t_v_tol_DEIM = (
    result_path + "/" + "Burger_list_data_diff_tol_diff_tim_DEIM" + ".npy"
)
filename_coef_track_DEIM = (
    result_path + "/" + "Burger_coef_track_dic_list_diff_tol_diff_tim_DEIM" + ".npy"
)


coef_dic_list_DEIM = np.load(filename_coef_DEIM, allow_pickle=True)
list_Burger_data_DEIM_t_div_tol = np.load(filename_data_t_v_tol_DEIM, allow_pickle=True)
...
axs[1].set(ylabel=r"\texttt{error} $u_{xx}$")
...
plt.savefig(
    result_path + "/" + "Burger_relative_abs_error_" + "GSPINN" + ".png",
    dpi=600,
    bbox_inches="tight",
)
plt.savefig(
    result_path + "/" + "Burger_relative_abs_error_" + "GSPINN" + ".pdf",
    dpi=600,
    bbox_inches="tight",
)
...
axs_2[0].set(ylabel=r"\texttt{error} $uu_{x}$")


axs_2[0].set(xlabel="Number of samples")
# axs_2[0].set(ylabel=r"Coefficient $u_{xx}$")
...
axs_2[1].set(ylabel=r"\texttt{error} $u_{xx}$")
